        ...
        <div className="technology">
            ...
            <main>
                <div className="tech-image">
                    <img
                        src={tech[currentIndex]?.images[imageType]}
                        alt="tech image"
                    />
                </div>
                <div className="content">
                    ...
                    <div className="tech-content">
                        <p className="tech-content-role">The Terminology...</p>
                        <div className="tech-content-name">
                            {tech[currentIndex].name}
                        </div>
                        <div className="paragraph">
                            {tech[currentIndex].description}
                        </div>
                    </div>
                </div>
            </main>
